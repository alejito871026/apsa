...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalEgresosAvances")
        ...
        async cambiarPagina (pagina) {
            ...
            let egresos = await this.$axios.$post("/contabilidad/egresosAvances", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let egresos = await this.$axios.$post("/contabilidad/egresosAvances",pagina)
