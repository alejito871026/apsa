...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalEgresosCompras")
        ...
        async cambiarPagina (pagina) {
            ...
            let egresos = await this.$axios.$post("/contabilidad/egresosCompras", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let egresos = await this.$axios.$post("/contabilidad/egresosCompras",pagina)
