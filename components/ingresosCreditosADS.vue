...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalIngresosCreditosADS")
        ...
        async cambiarPagina (pagina) {
            ...
            let ingresos = await this.$axios.$post("/contabilidad/ingresosCreditosADS", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let ingresos = await this.$axios.$post("/contabilidad/ingresosCreditosADS",pagina)
