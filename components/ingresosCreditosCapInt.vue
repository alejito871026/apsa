  ...
  <div class="p-4 text-center">
    <div class="card">
        <div class="card-header bg-white">
          <h4>Ingresos creditos capital - interes</h4>
        </div>
...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalIngresosCreditosCapInt")
        ...
        async cambiarPagina (pagina) {
            ...
            let ingresos = await this.$axios.$post("/contabilidad/ingresosCreditosCapInt", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let ingresos = await this.$axios.$post("/contabilidad/ingresosCreditosCapInt",pagina)
