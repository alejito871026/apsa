...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalEgresosNomina")
        ...
        async cambiarPagina (pagina) {
            ...
            let egresos = await this.$axios.$post("/contabilidad/egresosNomina", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let egresos = await this.$axios.$post("/contabilidad/egresosNomina",pagina)
