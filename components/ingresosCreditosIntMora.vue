  ...
  <div class="p-4 text-center">
    <div class="card">
        <div class="card-header bg-white">
          <h4>Ingresos creditos interes mora</h4>
        </div>
...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalIngresosCreditosInteresMora")
            console.log(paginas)
        ...
        async cambiarPagina (pagina) {
            ...
            let ingresos = await this.$axios.$post("/contabilidad/ingresosCreditosInteresMora", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let ingresos = await this.$axios.$post("/contabilidad/ingresosCreditosInteresMora",pagina)
