...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalIngresosInversiones")
        ...
        async cambiarPagina (pagina) {
            ...
            let ingresos = await this.$axios.$post("/contabilidad/ingresosInversiones", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let ingresos = await this.$axios.$post("/contabilidad/ingresosInversiones",pagina)
