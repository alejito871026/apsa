...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalIngresosComision")
        ...
        async cambiarPagina (pagina) {
            ...
            let ingresos = await this.$axios.$post("/contabilidad/ingresosComision", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let ingresos = await this.$axios.$post("/contabilidad/ingresosComision",pagina)
