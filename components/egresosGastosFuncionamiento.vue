  ...
  <div class="p-4 text-center">
    <div class="card">
        <div class="card-header bg-white">
          <h4>Egresos gastos funcioniento</h4>
        </div>
...
export default {
    ...
    methods : {
        ...
        async paginacion(posicion){
            ...
            let paginas = await this.$axios.$post("/contabilidad/totalEgresosFuncionamiento")
        ...
        async cambiarPagina (pagina) {
            ...
            let egresos = await this.$axios.$post("/contabilidad/egresosFuncionamiento", pag)
        ...
        async cargarIngresos(){
            let pagina = 1
            let egresos = await this.$axios.$post("/contabilidad/egresosFuncionamiento",pagina)
